    ...
    def __init__(self, in_channels_num, exp_size, out_channels_num, kernel_size, stride, use_SE, NL):
        ...
        if exp_size == in_channels_num:
            ...
            self.conv1 = nn.Sequential(
                ...
                nn.Conv2d(in_channels=in_channels_num, 
...
class MobileNetV3_base(nn.Module):
    ...
    '''
    def __init__(self, args, num_classes=100, width_multiplier=1.0, dropout=0.2, **kwargs):
        '''
        configs: setting of the model
        mode: type of the model, 'large' or 'small'
        '''
        super(MobileNetV3_base, self).__init__()
        s = 1
        ...
        self.last_stage_layer1 = nn.Sequential(
                nn.Conv2d(in_channels=input_channels_num, 
                          ...
                          bias=False),
                nn.GroupNorm(num_groups=2, 
                             num_channels=last_stage_channels_num),
                H_swish()
            )
